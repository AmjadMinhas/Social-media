        ...
        Route::group(['middleware' => ['check.organization']], function () {
            ...
            Route::group(['middleware' => 'check.subscription'], function () {
                ...
                Route::group(['middleware' => 'check.client.role'], function () {
                    ...
                    Route::delete('/developer-tools/access-tokens/{uuid}');

                    Route::get('/organization/show', [App\Http\Controllers\User\OrganizationController::class, 'show']);
                    Route::put('/organization/{uuid}', [App\Http\Controllers\User\OrganizationController::class, 'update']);
                    Route::delete('/organization/{uuid}', [App\Http\Controllers\User\OrganizationController::class, 'destroy']);
                });
