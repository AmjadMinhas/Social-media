<template>
    ...
    <aside
        ...
        <aside class="flex flex-col h-full w-full bg-white">
            <Menu :isSidebarOpen="isSidebarOpen" :config="props.config" :user="props.user" :organization="props.organization" :organizations="props.organizations" :unreadMessages="unreadMessages" @closeSidebar="closeSidebar()"></Menu>
        </aside>
    </aside>
