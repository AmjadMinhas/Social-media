<template>
  ...
  <li v-if="props.organizations.length > 1 && user.teams[0].role === 'owner'" class="hover:bg-slate-50 hover:text-black rounded-[5px] px-2 truncate">
                    <Link rel="noopener noreferrer" href="/organization/show" class="flex items-center p-2 space-x-3 rounded-md">
                        ...
                        <span  :class="menuIconsOnly ? 'hidden' : ''">{{ $t('Organizations') }}</span>
                    </Link>
                </li>
    ...
    <div @click="switchTeams()" class="border-2 border-primary text-sm rounded-[5px] mb-1 m-3 py-2 px-4 flex items-center justify-between cursor-pointer">
